"""
Downward parabola with positive shift (y = -x^2 + a).
...
A_SHIFT_FOR_CASE = 10  # Fixed value for matching graph case
...
def get_graph_dict(a_shift=None):
    ...
    a_shift_for_label = shift_magnitude  # Positive for this case (even though it's sm1)

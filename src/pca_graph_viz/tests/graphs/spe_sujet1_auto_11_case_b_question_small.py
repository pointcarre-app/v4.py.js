...
# Case B: root1=-4, root2=3, root3=5
...
foreign_objects = [
    ...
    # Root labels (positioned below dots with better control)
    {
        ...
        "height": 14,
        "class": "svg-latex fill-base-content text-sm",
        "style": "overflow: visible; text-align: center; background: rgba(255, 255, 255, 0.7); border-radius: 2px;",
    },
    {
...
def get_graph_dict():
    ...
    return {
        "id": "cubic-function-small-case-b",
        "title": "spe_sujet1_auto_11_case_b_question_small.py",
        "description": "Small visualization of cubic function with three roots - Case B (200x200)",
        "svg": {
            "width": 200,
            "height": 200,
            "viewBox": "0 0 200 200",

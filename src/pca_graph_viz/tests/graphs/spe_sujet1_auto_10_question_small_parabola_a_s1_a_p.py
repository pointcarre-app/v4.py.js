...
try:
    ...
    print(f"✅ Using injected A_SHIFT_MAGNITUDE = {A_SHIFT_MAGNITUDE} for s1_a_p label")
except KeyError:
    # Default value when not running via Nagini or value not injected
    A_SHIFT_MAGNITUDE = 5
    print(f"⚠️ Using default A_SHIFT_MAGNITUDE = {A_SHIFT_MAGNITUDE} for s1_a_p label")

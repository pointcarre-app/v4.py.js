...
# Description: Discrete points forming a linear pattern. Points lie on a straight line (but don't connect them). Common difference d shown between consecutive terms. Formula uₙ = u₁ + (n-1)d displayed.
...
def get_graph_dict():
    ...
    return {
        ...
        "description": "Placeholder for arithmetic sequence graph visualization",
        "svg": {
            "width": 340,
            "height": 340,
            "viewBox": "0 0 340 340",

...
# Description: Discrete points forming exponential pattern. For increasing sequences, points rise exponentially. For decreasing sequences (0 < r < 1), points approach zero. Common ratio r indicated between terms.
...
def get_graph_dict():
    ...
    return {
        ...
        "description": "Placeholder for geometric sequence graph visualization",
        "svg": {
            "width": 340,
            "height": 340,
            "viewBox": "0 0 340 340",
